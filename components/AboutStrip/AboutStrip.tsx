    ...
    <div className="relative bg-gradient-to-b from-transparent via-black/50 to-black">
      <div className="mt-0 sm:mt-10 px-8 lg:px-16 flex-col md:flex-row">
        <div className="flex flex-col sm:flex-row items-center sm:justify-between gap-4 sm:gap-0">
          {/* Logos section */}
          <div className="flex justify-between items-center w-full px-0 sm:justify-center order-1 sm:order-2">
            <div className="transform transition-all duration-300 hover:scale-105 -ml-2">
              <a href="https://jklu.edu.in/council-of-technical-affairs/">
                <Image
                  ...
                  alt="Tech Affair"
                  src={TechhLogo}
                  className="object-contain w-[120px] h-[80px] sm:w-[40px] sm:h-[40px] md:w-[50px] md:h-[50px] lg:w-[55px] lg:h-[55px]"
                />
              </a>
            </div>
            <div className="transform transition-all duration-300 hover:scale-105">
              <a href="https://jklu.edu.in/">
                <Image
                  ...
                  alt="JKLU"
                  src={JKLULogo}
                  className="object-contain w-[75px] h-[75px] sm:w-[40px] sm:h-[40px] md:w-[50px] md:h-[50px] lg:w-[55px] lg:h-[55px]"
                />
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-10 items-end mt-4 sm:mt-0 order-2 sm:order-1 w-full pr-2">
            <Link target="_blank" href={"https://www.instagram.com/hackjklu"}>
              <Instagram size={25} className="hover:fill-neonGreen transition-all" />
            </Link>
            <Link target="_blank" href={"https://www.youtube.com/@CouncilofTechnicalAffairs"}>
              <Youtube size={25} className="hover:fill-neonGreen transition-all" />
            </Link>
            <Link target="_blank" href={"https://www.linkedin.com/in/council-of-technical-affairs-jklu/"}>
              <Linkedin size={25} className="hover:fill-neonGreen transition-all" />
            </Link>
          </div>
        </div>
      </div>
